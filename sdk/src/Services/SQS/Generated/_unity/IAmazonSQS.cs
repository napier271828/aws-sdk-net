...
namespace Amazon.SQS
{
    ...
    public partial interface IAmazonSQS : IAmazonService, IDisposable
    {
        ...
        void ListQueueTagsAsync(ListQueueTagsRequest request, AmazonServiceCallback<ListQueueTagsRequest, ListQueueTagsResponse> callback, AsyncOptions options = null);
        ...
        void TagQueueAsync(TagQueueRequest request, AmazonServiceCallback<TagQueueRequest, TagQueueResponse> callback, AsyncOptions options = null);
        ...
        void UntagQueueAsync(UntagQueueRequest request, AmazonServiceCallback<UntagQueueRequest, UntagQueueResponse> callback, AsyncOptions options = null);
